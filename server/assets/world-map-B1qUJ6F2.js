import { $ as getDefaultExportFromCjs, r as reactExports, S as React, T as jsxRuntimeExports } from "./worker-entry-D1Y2Ppya.js";
import { u as useNavigate, C as COUNTRY_ORDER, a as COUNTRIES } from "./router-HSVd_pVe.js";
...
function transform$1(transform2) {
...
function object(topology, o) {
  var transformPoint = transform$1(topology.transform), arcs2 = topology.arcs;
...
function stitch(topology, arcs2) {
  ...
  arcs2.forEach(function(i, j) {
    var arc = topology.arcs[i < 0 ? ~i : i], t;
    if (arc.length < 3 && !arc[1][0] && !arc[1][1]) {
      t = arcs2[++emptyIndex], arcs2[emptyIndex] = i, arcs2[j] = t;
    }
  });
  arcs2.forEach(function(i) {
...
function meshArcs(topology, object2, filter2) {
  var arcs2, i, n;
  if (arguments.length > 1) arcs2 = extractArcs(topology, object2, filter2);
  else for (i = 0, arcs2 = new Array(n = topology.arcs.length); i < n; ++i) arcs2[i] = i;
...
function extractArcs(topology, object2, filter2) {
  ...
  geomsByArc.forEach(filter2 == null ? function(geoms) {
    ...
    if (filter2(geoms[0].g, geoms[geoms.length - 1].g)) arcs2.push(geoms[0].i);
  });
  return arcs2;
}
var noop = { value: () => {
...
function WorldMap() {
  ...
  const geographiesData = reactExports.useMemo(() => {
    const topology = worldTopology;
    const countriesObject = topology.objects.countries;
    const fc = feature(topology, countriesObject);
    return fc.type === "FeatureCollection" ? fc : { type: "FeatureCollection", features: [] };
  }, []);
  const go = (key) => {
    navigate({ to: "/solutions/$country", params: { country: key } });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full overflow-hidden rounded-3xl border border-border bg-(image:--gradient-warm) p-2 shadow-[var(--shadow-elegant)] sm:p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ComposableMap,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: 980, height: 500, fill: "oklch(0.93 0.03 220)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Geographies, { geography: geographiesData, children: ({ geographies: mapGeographies }) => mapGeographies.map((geo) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: hovered ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs uppercase tracking-[0.18em] text-accent", children: [
            COUNTRIES[hovered].flag,
            " Target Market"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-display text-2xl text-primary", children: COUNTRIES[hovered].name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm text-muted-foreground", children: COUNTRIES[hovered].tagline })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-[0.18em] text-primary", children: "Interactive Map" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-display text-xl text-foreground", children: "5 Priority Markets · 2030" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm text-muted-foreground", children: "Hover or tap any highlighted country to explore its tailored expansion solution." })
        ] })
      }
    )
  ] });
