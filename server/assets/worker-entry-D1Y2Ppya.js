...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CpLCpJ0e.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-HSVd_pVe.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "juan-valdez-insight";
var SERVER_FN_BASE = "/juan-valdez-insight/_serverFn/";
