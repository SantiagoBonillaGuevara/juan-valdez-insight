...
import { R as Route, L as Link, a as COUNTRIES, C as COUNTRY_ORDER } from "./router-HSVd_pVe.js";
    ...
    sections: [
      {
        ...
        intro: "The goal is to solidify Juan Valdez's presence in the United States through an entry model based on cultural identity and premium quality. Unlike a mass-market entry focused solely on price, the brand will position itself as a superior product, leveraging the 'nostalgic connection' of the Latino community and the curiosity of local consumers."
      },
      {
        title: "Retail and Distribution Strategy (Sales Channels)",
        intro: "To achieve effective but segmented national coverage, three large chains representing different consumer profiles have been selected:",
        bullets: [
    ...
    sections: [
      {
        ...
        intro: "Unlike the mass distribution model in US retail, in the UK the brand will position itself through an experiential retail model. The aim is to compete in the specialty coffee segment, shifting the perception of coffee from a commodity to an accessible luxury experience with guaranteed origin."
      },
      {
    ...
    sections: [
      {
        ...
        intro: "South Korea represents one of Juan Valdez's most aggressive growth opportunities due to its very high consumption culture. The goal is to position itself as the benchmark for single-origin coffee in a market that consumes, on average, 405 cups per person per year, far exceeding the global average."
      },
      {
    ...
    sections: [
      {
        ...
        intro: "The Saudi Arabian market will be approached with an ultra-premium concept. Given that coffee (Gahwa) is a symbol of generosity in their culture, Juan Valdez will be positioned not just as a beverage, but as a status symbol and a high-end sensory experience."
      },
      {
    ...
    sections: [
      {
        ...
        intro: "Mexico is a mature market with a growing coffee culture. Juan Valdez's goal is to position itself as the leading specialty coffee option, differentiating itself from local and global chains through the superior quality of Colombian coffee beans and the in-store experience."
      },
      {
...
function CountrySolutionPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden bg-(image:--gradient-coffee) text-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/solutions", className: "text-xs uppercase tracking-[0.22em] text-gold hover:underline", children: "← All Solutions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-6xl", children: c.flag }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs uppercase tracking-[0.22em] text-gold", children: [
            "Strategy 7.",
            idx + 1
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-5xl md:text-6xl", children: c.name })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 max-w-3xl text-xl text-cream/85", children: c.tagline }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 grid gap-3 sm:grid-cols-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "GDP per capita", value: c.gdpPerCapita }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "CAGE Determinant", value: c.cageFactor }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Verdict", value: c.verdict })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-4xl px-6 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-12", children: content.sections.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl text-primary", children: s.title }),
        s.intro && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-foreground/90", children: s.intro }),
        s.bullets && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-5 space-y-3", children: s.bullets.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3 rounded-xl border border-border bg-card p-4 shadow-[var(--shadow-soft)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 h-2 w-2 shrink-0 rounded-full bg-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground/90", children: [
            b.bold && /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { className: "text-secondary", children: [
              b.bold,
              ": "
            ] }),
            b.text
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 flex items-center justify-between gap-4 border-t border-border pt-8", children: [
        prev ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/solutions/$country", params: {
          country: prev
        }, className: "group flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.22em] text-muted-foreground", children: "Previous" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-xl text-primary group-hover:text-accent", children: [
            "← ",
            COUNTRIES[prev].name
          ] })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
        next ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/solutions/$country", params: {
          country: next
        }, className: "group flex flex-col text-right", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.22em] text-muted-foreground", children: "Next" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-xl text-primary group-hover:text-accent", children: [
            COUNTRIES[next].name,
            " →"
          ] })
...
function Stat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-cream/15 bg-cream/5 p-4 backdrop-blur", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.22em] text-gold", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm text-cream", children: value })
  ] });
}
export {
  CountrySolutionPage as component
};
