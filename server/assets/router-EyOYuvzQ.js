...
const Route$6 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Juan Valdez Global Insights is a website presenting business case competition information for Juan Valdez." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Juan Valdez Global Expansion Strategy" },
      { property: "og:description", content: "Juan Valdez Global Insights is a website presenting business case competition information for Juan Valdez." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Juan Valdez Global Expansion Strategy" },
      { name: "twitter:description", content: "Juan Valdez Global Insights is a website presenting business case competition information for Juan Valdez." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9a9b7706-796c-48f5-9210-c5282d2d077e/id-preview-84334ace--88636f4e-6403-4130-ba11-ce07c6300060.lovable.app-1776740072120.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9a9b7706-796c-48f5-9210-c5282d2d077e/id-preview-84334ace--88636f4e-6403-4130-ba11-ce07c6300060.lovable.app-1776740072120.png" }
    ],
    links: [
...
const $$splitComponentImporter$5 = () => import("./markets-LlV7MspG.js");
const Route$5 = createFileRoute("/markets")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Detailed CAGE analysis across Large Economies, Emerging Coffee Markets, Mature/Specialty markets and Experience pilots — leading to the 5 final selected countries."
    }, {
      property: "og:title",
      content: "CAGE Analysis & Market Comparison · Juan Valdez"
    }, {
      property: "og:description",
      content: "Comparative CAGE tables and final verdict for each candidate country."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./framework-Dl3y7MyC.js");
const Route$4 = createFileRoute("/framework")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A scientific 3-filter framework (CAGE, Specialty Coffee Potential, Procafecol Fit) to reduce expansion to 5 priority markets by 2030."
    }, {
      property: "og:title",
      content: "Market Selection Framework · Juan Valdez"
    }, {
      property: "og:description",
      content: "CAGE Distance + Specialty Coffee potential + Strategic Fit — the methodology behind the 5 priority markets."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./diagnosis-BdamkzKd.js");
const Route$3 = createFileRoute("/diagnosis")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Diagnosis of Juan Valdez's current internationalization gap and the 2030 KPI targets to correct course."
    }, {
      property: "og:title",
      content: "Diagnosis & 2030 KPIs · Juan Valdez IBCC"
    }, {
      property: "og:description",
      content: "What — How — Why behind Juan Valdez's internationalization disconnect, plus quantified 2030 success metrics."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-CZm8MQqR.js");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Comprehensive global expansion strategy for Juan Valdez Café — IBCC case study with interactive market map of the 5 priority countries for 2030."
    }, {
      property: "og:title",
      content: "Juan Valdez · Global Expansion Strategy 2030"
    }, {
      property: "og:description",
      content: "Interactive IBCC case: doubling sales by 2030 with a scientific market selection framework across USA, UK, South Korea, Saudi Arabia and Mexico."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./solutions.index-DxBKT3Q_.js");
const Route$1 = createFileRoute("/solutions/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tailored expansion solutions for Juan Valdez Café in the United States, United Kingdom, South Korea, Saudi Arabia and Mexico."
    }, {
      property: "og:title",
      content: "5 Country Solutions · Juan Valdez"
    }, {
      property: "og:description",
      content: "Click any country on the interactive map to read its full expansion strategy."
    }]
  }),
...
const COUNTRIES = {
  usa: {
    ...
    verdict: "✅ Enter",
    mapPath: "M 150 175 L 270 170 L 295 195 L 285 230 L 240 245 L 200 245 L 175 230 L 150 210 Z",
    labelXY: [220, 210]
  },
  mexico: {
    key: "mexico",
    ...
    verdict: "✅ Enter",
    mapPath: "M 195 250 L 245 245 L 255 270 L 240 285 L 215 285 L 200 270 Z",
    labelXY: [225, 268]
  },
  uk: {
    key: "uk",
    ...
    verdict: "✅ Enter",
    mapPath: "M 478 158 L 491 156 L 495 168 L 489 178 L 478 178 L 472 168 Z",
    labelXY: [484, 168]
  },
  saudi: {
    key: "saudi",
    ...
    verdict: "✅ Enter",
    mapPath: "M 575 215 L 615 213 L 625 235 L 615 258 L 590 260 L 575 245 Z",
    labelXY: [600, 235]
  },
  korea: {
    key: "korea",
    ...
    verdict: "✅ Enter",
    mapPath: "M 800 205 L 818 203 L 822 218 L 815 228 L 802 226 L 798 215 Z",
    labelXY: [810, 215]
  }
};
const COUNTRY_ORDER = ["usa", "uk", "korea", "saudi", "mexico"];
const $$splitErrorComponentImporter = () => import("./solutions._country-B_LYuiBP.js");
const $$splitNotFoundComponentImporter = () => import("./solutions._country-CoR1KePk.js");
const $$splitComponentImporter = () => import("./solutions._country-C7QwQrlm.js");
const Route2 = createFileRoute("/solutions/$country")({
  ...
  head: ({
    ...
    if (!c) {
      return {
        meta: [{
          title: "Country not found · Juan Valdez IBCC"
        }]
      };
    }
    return {
      meta: [{
        ...
        name: "description",
        content: `${c.name}: ${c.tagline}. ${c.entryStrategy}`
      }, {
        property: "og:title",
        content: `Juan Valdez in ${c.name}`
      }, {
        property: "og:description",
        content: c.tagline
      }]
...
const MarketsRoute = Route$5.update({
  id: "/markets",
  path: "/markets",
  getParentRoute: () => Route$6
});
const FrameworkRoute = Route$4.update({
  id: "/framework",
  path: "/framework",
  getParentRoute: () => Route$6
});
const DiagnosisRoute = Route$3.update({
  id: "/diagnosis",
  path: "/diagnosis",
  getParentRoute: () => Route$6
});
...
const SolutionsIndexRoute = Route$1.update({
  id: "/solutions/",
  path: "/solutions/",
  getParentRoute: () => Route$6
});
const SolutionsCountryRoute = Route2.update({
